  ...
  useEffect(() => {
    ...
    if (keyword !== '') {
      const newTableData = tableData1.filter((data) => {
        return Object.values(data).join(" ").toLowerCase().includes(keyword.toLowerCase())
      })
  ...
  return (
    <>
      ...
      <div className="table_container">
        ...
        <Table caption="" key={tableData} data={tableData} columns={columns} />
        <br />
      </div>
      <div className="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between          ">
                  ...
                  <div className="inline-flex mt-2 xs:mt-0">
                    <button
                      onClick={() => {setCurrentPage(currentPage - 1);console.log('currentPage', currentPage)}}
